...
public class los_angeles_Tshirt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_los_angeles_tshirt);
        ...
        toFav.setOnClickListener(v -> {
            Intent intent = new Intent(los_angeles_Tshirt.this, HomeActivity.class);
