...
public class new_york_Tshirt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_york_tshirt);
        ...
        toFav.setOnClickListener(v -> {
            Intent intent = new Intent(new_york_Tshirt.this, HomeActivity.class);
